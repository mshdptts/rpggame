...
public class enemy extends player {
    ...
    public enemy(String name, int health, int attack, ArrayList<String> inventory,
                 String race, int expReward, double fleeChance, boolean canHeal) {
    ...
    public static enemy createGoblin() {
        return new enemy("Goblin", 150, 20, new ArrayList<>(), "Goblin", 30, 0.3, false);
    }

    public static enemy createOgre() {
        return new enemy("Ogre", 400, 45, new ArrayList<>(), "Ogre", 100, 0.0, false);
    }

    public static enemy createImp() {
        return new enemy("Imp", 100, 15, new ArrayList<>(), "Imp", 20, 0.6, false);
    }

    public static enemy createMage() {
        return new enemy("Mage", 100, 50, new ArrayList<>(), "human", 75, 0.2, true);
    }

    public static enemy createCursedCorpse() {
        return new enemy("Cursed Corpse", 75, 95, new ArrayList<>(), "Cursed Corpse", 50, 0.0, false);
    }
}
